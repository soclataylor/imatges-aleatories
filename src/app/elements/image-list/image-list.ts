...
export class ImageList {
  ...
  public gossos: InputSignal<{ img: string; title: string }[]> = input<{ img: string; title: string }[]> ([]);
  ...
  public imatgeSelec: OutputEmitterRef<{img:string, title:string}> = output<{img:string, title:string}>();


  //OUTPUT: EMET DADES AL PARE (App) - per emetre la imatge que ha entrat l'usuari al formulari;
  public imatgeNova: OutputEmitterRef<{img:string, title:string}> = output<{img:string, title:string}>();
